...
// treated as too old, because refusing to start an application over an unfamiliar
// string would make every Docker release an outage. The failure this guards
// against announces itself clearly.
type Version struct {
	Major, Minor int
	Text         string
	Parsed       bool
