...
// ownership is a Unix facility besides (ADR-027). This file exists so the package
// still builds elsewhere and says what it cannot do, rather than failing to compile
// with an error about a missing function.
